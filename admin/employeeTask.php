                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="staff_id" class="form-control" required>
                                                ...
                                                ?>
                                                    <option class="card" value="<?php echo $staff['staff_id']; ?>" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="status" class="form-control" required>
                                                <option class="card" value="Pending" <?php echo $row['status'] == 'Pending' ? 'selected' : ''; ?>>Pending</option>
                                                <option class="card" value="In Progress" <?php echo $row['status'] == 'In Progress' ? 'selected' : ''; ?>>In Progress</option>
                                                <option class="card" value="Done" <?php echo $row['status'] == 'Done' ? 'selected' : ''; ?>>Done</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <form action="../controllers/taskController.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label>Status</label>
                                <select name="status" class="form-control" required>
                                    <option class="card" value="Pending">Pending</option>
                                    <option class="card" value="In Progress">In Progress</option>
                                    <option class="card" value="Completed">Completed</option>
                                </select>
                            </div>
                        </div>
                        <div class="modal-footer">
